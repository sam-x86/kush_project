...
"""
Kush Framework Engine - Empire-inspired design - FIXED VERSION
"""
...
class KushEngine(cmd.Cmd):
    """Main Kush Framework engine with Empire-style interface - FIXED VERSION"""
...
"""
    ...
    def __init__(self):
        ...
        # FIXED: Pass listener_manager to stager_manager
        self.stager_manager = StagerManager(listener_manager=self.listener_manager)
